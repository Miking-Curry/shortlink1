...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    @Override
    public void update(UserUpdateReqDTO requrstParam) {
        //验证当前登入用户是否为登录用户

        LambdaUpdateWrapper<UserDO> updateWrapper = Wrappers.lambdaUpdate(UserDO.class)
                .eq(UserDO::getUsername,requrstParam.getUsername());
        baseMapper.update(BeanUtil.toBean(requrstParam,UserDO.class),updateWrapper);
    }

    @Override
    public UserLoginRespDTO login(UserUpdateReqDTO requestParam) {
        LambdaQueryWrapper<UserDO> queryWrapper = Wrappers.lambdaQuery(UserDO.class)
