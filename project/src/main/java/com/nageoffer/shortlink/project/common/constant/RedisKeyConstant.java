...
public class RedisKeyConstant {
     ...
     * 短链接跳转前缀key
     */
    public static final String GOTO_LINK_KEY = "short-link:goto:%s";

    /**
     * 短链空值跳转前缀key
     */
    public static final String GOTO_IS_NULL_LINK_KEY = "short-link:is-null:goto:%s";


    /**
     * 短链接跳转锁前缀key
     */
    public static final String LOCK_GOTO_LINK_KEY = "short-link:lock:goto:%s";
