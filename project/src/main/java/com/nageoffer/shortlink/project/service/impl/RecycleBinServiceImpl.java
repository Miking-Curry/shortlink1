...
import static com.nageoffer.shortlink.project.common.constant.RedisKeyConstant.GOTO_IS_NULL_LINK_KEY;
...
public class RecycleBinServiceImpl extends ServiceImpl<ShortLinkMapper,ShortLinkDO> implements RecycleBinService {
    ...
    public void saveRecycleBin(RecycleBinSaveReqDTO requestParam) {
        ...
        stringRedisTemplate.delete(
                String.format(GOTO_LINK_KEY,requestParam.getFullShortUrl()));
    }
    ...
    public IPage<ShortLinkPageRespDTO> pageShortLink(ShortLinkRecycleBinPageReqDTO requestParam) {
        ...
        // 参数校验：gidList 不能为空
        if (requestParam == null || CollectionUtils.isEmpty(requestParam.getGidList())) {
            throw new IllegalArgumentException("gidList cannot be empty");
        }
